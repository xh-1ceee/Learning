...
class Thread;
extern int threadIdMap[128];
extern Thread* allThreads[128];
...
class Thread {
  ...
  public:
    ...
    int getUserProgramId(){return UserProgramId;}
    void CleanUp();
  private:
...
// while executing kernel code.
  ...
  public:
    ...
    void Join(int tid);
    void Terminated();
    int getExitStatus() { return waitProcessExitCode; }
...
int threadIDComp(void *target, void *data);//比较tid是否相同
}
